        ...
        <div class="row justify-content-center mt-5">
            ...
            <form id="formulario_editar" method="POST" action="{{ route('Admin.producto.update', $producto->id) }}" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nombre" name="nombre" class="form-control  @error('nombre') is-invalid  @enderror"  placeholder="2222" value="{{ old('nombre', $producto->nombre) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="descripcion" name="descripcion" class="form-control 
                     @error('descripcion') is-invalid  @enderror"  placeholder="2222" value="{{ old('descripcion', $producto->descripcion) }}">
                ...
                <div class="form-group">
                    ...
                    @error('cantidad') is-invalid  @enderror"  placeholder="2222" value="{{ old('cantidad', $producto->cantidad) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="precio" name="precio" class="form-control  @error('precio') is-invalid  @enderror" 
                     placeholder="2222" value="{{ old('precio', $producto->precio) }}">
                ...
                <div class="form-group">
                    ...
                    placeholder="2222" value="{{ old('foto', $producto->foto) }}">
