    ...
    <div class="col-md-8">
        <form id="formulario_crear" method="POST" action="{{ route('Admin.compra.store') }}" novalidate>
            ...
            <div class="form-group">
                ...
                <select id="id_proveedor_select" name="id_proveedor" class="form-control">
            ...
            <div class="form-group">
                ...
                <select id="id_insumo" name="id_insumo" class="form-control">
...
function agregarCarrito() {
    ...
    const item = { id_categoria_insumo, id_insumo, nombre_insumo, cantidad, costo_unitario, subtotal };
    carrito.push(item);
    actualizarCarrito();
...
// Actualizar el costo unitario cuando se selecciona un insumo
