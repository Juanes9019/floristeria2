            ...
            <form class="p-4 md:p-5">
                ...
                <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-800">
                    ...
                    <div class="grid gap-4 grid-cols-1 md:grid-cols-2">
                        <div class="form-group">
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Categoría de Insumo</label>
                        ...
                        <div class="form-group">
                            ...
                            <select wire:model="insumo_seleccionado" id="insumo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
