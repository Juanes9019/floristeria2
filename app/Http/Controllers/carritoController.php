...
public function removeItem(Request $request)
{
    ...
    public function confirmarCarrito(Request $request)
    {
        ...
        if ($response->successful()) {
            ...
            $pedido->datos_envio = json_encode($datosEnvio);
            $pedido->save();
            ...
            // Lógica para detalles del pedido
            try {
                ...
                return response()->view('errors.error', ['error' => 'Error al procesar el pedido. Inténtalo nuevamente.']);
            }
